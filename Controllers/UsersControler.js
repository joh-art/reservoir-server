...
protectRoute : async (req, res) => {
  ...
  try {
    ...
    // Assuming you have a way to identify the user, such as a user ID in the decoded token
    const userId = decoded.userId; // Adjust this based on your token structure
